...
int main (int argc, char **argv)
{
    ...
    {
        fscanf(fp, "%s", line);
        //fp has the file pointer, and is basically the variable the file name is stored to.
        //"%s" is the format specifier and specifies what fscanf is scanning for,stored in variable line
        printf("%s ", line);
